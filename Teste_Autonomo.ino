...
char linha_direita_char = '?', linha_traseira_char = '?', linha_esquerda_char = '?';
...
// --- NOVO: Constante para ajuste de direção durante o ataque ---
const int DIFERENCA_MINIMA_LATERAL_AJUSTE_MM = 40; // Ajustar experimentalmente
...
int limiarPretoBranco = 1000;

// ==========================================================================
// Página de Controle (HTML) - Sem alterações
// ==========================================================================
...
void setup() {
    ...
    Serial.println("Robo pronto. MODO AUTOMATICO (PADRAO SIMULADO) ATIVADO PARA TESTE.");
}
    ...
    server.on("/mode", HTTP_GET, [](AsyncWebServerRequest *request) {
        if (request->hasParam("set")) {
            ...
            if (mode == "auto") {
                ...
                estadoAtualAuto = AVANCAR_PROCURANDO; 
                pararMotores(); 
                Serial.println("Modo automatico (PADRAO SIMULADO) ATIVADO via Web");
            } else if (mode == "manual") {
...
// --- ATUALIZADO: Lógica de controle automático com detecção de inimigo, prioridade de borda e ALINHAMENTO ---
void controleAutomatico() {
    ...
    switch (estadoAtualAuto) {
        case AVANCAR_PROCURANDO:
            ...
            if (algumaBordaDetectada) {
                ...
                // Não precisa parar nem mover, pois a lógica de ATACAR_INIMIGO decidirá o movimento.
            }
            break;

        case ATACAR_INIMIGO:
            // Prioridade 1: Evitar Borda
            if (algumaBordaDetectada) {
            ...
            // Prioridade 2: Verificar se o inimigo ainda está visível frontalmente
            ...
            // Prioridade 3: Alinhar e Atacar
            // Tratar 9999 como distância muito grande para não interferir nas comparações de desalinhamento
            int dE_comp = (dist_esquerda_mm == 9999) ? 10000 : dist_esquerda_mm;
            int dD_comp = (dist_direita_mm == 9999) ? 10000 : dist_direita_mm;

            // Condição para ajustar para esquerda: inimigo está mais à esquerda E o sensor esquerdo detecta algo próximo
            ...
            // Condição para ajustar para direita: inimigo está mais à direita E o sensor direito detecta algo próximo
            ...
            // Se relativamente alinhado, ou só o sensor frontal detecta claramente o inimigo
            else {
